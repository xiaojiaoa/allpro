<template>
  <div class="container">
    ...
    <div class="default-detail" v-loading.lock="loading">
      ...
      <el-row class="textarea">
        <el-col>
          ...
          <el-col class="text el-8-9">
            <template v-for="(item, index) in sameCustomerOrder" v-if="index < 5 && item.orderResupplyReturnVo.tno !== orderResupplyBasicInfo.tno">
      ...
      <el-row class="textarea">
        <el-col>
          ...
          <el-col class="text el-8-9">
            <template v-for="(item, index) in sameCustomerLid" v-if="index < 5 && item.no !== orderResupplyBasicInfo.lno">
    ...
    <div class="page-oper">
     ...
     <ul class="page-methods">
        <!-- 订单审核 -->
        <template v-if="$_has8('review01') && orderResupplyBasicInfo.lockGid == employee.id">
        ...
        <!-- 订单拆单 -->
        <template v-if="$_has8('apartOrder01') && orderResupplyBasicInfo.lockGid == employee.id">
        ...
        <!-- 订单拆审 -->
        <template v-if="$_has8('apartReview01') && orderResupplyBasicInfo.lockGid == employee.id">
        ...
        <!-- 订单排料 -->
        <template v-if="$_has8('schedule01') && orderResupplyBasicInfo.lockGid == employee.id">
         ...
         <!-- 补单受理 -->
        <template v-if="$_has8('accepted01') && orderResupplyBasicInfo.lockGid == employee.id">
