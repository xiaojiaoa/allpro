  ...
  <div class="container dis-flex">
    <div class="page-oper">
      ...
      <ul class="page-methods">
        <li>
          <el-button type="primary" @click="nextPage">填写请购信息</el-button>
        </li>
      </ul>
    </div>
  ...
  export default {
    ...
    methods: {
      init: function (val) {
        ...
        Purchase.supMateAbleList(val).then(res => {
          ...
          if (storage.get('REQMATE')) {
            this.checkList = storage.get('REQMATE');
            this.showList = [];
      ...
      checkChange: function () {
        ...
        storage.set('REQMATE', []);
        storage.set('REQMATE', this.checkList);
      },
      query: function (val) {
      ...
      nextPage: function () {
        if (this.checkList.length === 0) {
          ...
          this.$router.push('/purchase/requisition/editTwo');
        }
      },
    },
    computed: {
